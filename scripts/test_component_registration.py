...
tekton_dir = hermes_dir.parent.absolute()
...
# Component paths
COMPONENT_PATHS = {
    "sophia": os.path.join(tekton_dir, "Sophia"),
    "prometheus": os.path.join(tekton_dir, "Prometheus"),
    "telos": os.path.join(tekton_dir, "Telos"),
    "harmonia": os.path.join(tekton_dir, "Harmonia"),
    "rhetor": os.path.join(tekton_dir, "Rhetor"),
    "athena": os.path.join(tekton_dir, "Athena")
}
