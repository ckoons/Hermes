"""
Port configuration utilities for Hermes component.
...
PORT_ASSIGNMENTS = {
    ...
    "tekton_core": 8010,
    "llm_adapter": 8300,
    "db_mcp": 8002,  # Database MCP uses the same port as Ergon since they're not run together
}
...
def get_db_mcp_port():
    """
    Get the configured port for the Database MCP component.
    
    Returns:
        int: The port number for Database MCP (default 8002)
    """
    return get_component_port("db_mcp")
